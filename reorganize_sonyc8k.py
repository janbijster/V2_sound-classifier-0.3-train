...
# default params
input_folder = './data/sonyc-8k/UrbanSound8K/audio'
metadata_path = './data/sonyc-8k/UrbanSound8K/metadata/UrbanSound8K.csv'
    ...
    for folddirname in sorted(dirs):
        for file in glob.glob(os.path.join(input_folder, folddirname + '/*')):
            ...
            try:
                ...
                print('Couldn\'t find metadata row for file id {} in dir {}, skipping.'.format(file_id, folddirname))
                continue
